...
### 配置SSH无密码登录 [链接地址](https://www.lijianhang.top/posts/ssh无密登录/)

### ntp同步各时间节点 [链接地址](https://www.lijianhang.top/posts/ntp时间同步/)

### 安装JDK [链接地址](https://www.lijianhang.top/posts/jdk环境配置/)

除以上配置外需要按cdh的/opt/cm5/lib64/cmf/service/common/cloudera-config.sh文件来修改创建一部分链接，用于让cdh能管理的软件进行使用。

### 安装mysql [链接地址](https://www.lijianhang.top/posts/mysql安装/)
...
详细信息请点击 [链接地址](https://www.lijianhang.top/posts/swappiness/)
...
配置NTP服务 [链接地址](https://www.lijianhang.top/posts/ntp时间同步/)
